...
#include "source_sdk/public/mathlib/mathlib.h"
#include "source_sdk/public/mathlib/vector.h"
#if !defined( _X360 )
#include "source_sdk/public/mathlib/amd3dx.h"
#ifndef OSX
#include "source_sdk/mathlib/3dnow.h"
#endif
#include "source_sdk/mathlib/sse.h"
#endif

#include "source_sdk/public/mathlib/ssemath.h"
#include "source_sdk/public/mathlib/ssequaternion.h"
...
const Vector vec3_origin_sdk(0,0,0);
...
int PolyFromPlane( Vector *outVerts, const Vector& normal, float dist, float fHalfScale )
{
	...
	VectorCopy (vec3_origin_sdk, vup);
	switch (x)
	{
	case 0:
	case 1:
