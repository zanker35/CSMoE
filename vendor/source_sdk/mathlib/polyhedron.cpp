...
#include "source_sdk/public/mathlib/polyhedron.h"
#include "source_sdk/public/mathlib/vmatrix.h"
#include <stdlib.h>
#include <stdio.h>
...
#include "source_sdk/public/tier0/memdbgoff.h" //the following placement new doesn't compile with memory debugging
...
void DumpLineToGLView( const Vector &vPoint1, const Vector &vColor1, const Vector &vPoint2, const Vector &vColor2, float fThickness, FILE *pFile )
{
	...
	Vector vPseudoPerpandicular = vec3_origin_sdk;
