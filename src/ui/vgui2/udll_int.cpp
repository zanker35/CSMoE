...
#include "engine_api/types/gameinfo.h"
#include "engine_api/types/keydefs.h"
#include "ui/vgui2/keydest.h"
#include "engine_api/types/netadr.h"
...
void UI_GetCursorPos(int* pos_x, int* pos_y)
{
	if (g_api && g_api->GetCursorPos)
		g_api->GetCursorPos(pos_x, pos_y);
}
void UI_SetCursorPos(int pos_x, int pos_y)
{
	if (g_api && g_api->SetCursorPos)
		g_api->SetCursorPos(pos_x, pos_y);
}
void UI_ShowCursor(int show)
{
	if (g_api && g_api->SetVisible)
		g_api->SetVisible(show);
}
