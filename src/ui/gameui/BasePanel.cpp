...
#include "ui/vgui2/vgui_controls/AnimationController.h"
...
#include "ui/vgui2/vgui_controls/PHandle.h"
#include "ui/vgui2/vgui_controls/MessageBox.h"
#include "ui/vgui2/vgui_controls/QueryBox.h"
#include "ui/vgui2/vgui_controls/InputDialog.h"
#include "ui/vgui2/vgui_controls/ControllerMap.h"
...
#include "ui/gameui/CreateMultiplayerGameDialog.h"
#include "ui/gameui/MoeSettings.h"

#include "ui/gameui/ToolBar.h"
#include "engine_api/types/keydefs.h"
...
void CBasePanel::ApplySchemeSettings(vgui2::IScheme *pScheme)
{
	...
	FileHandle_t file = vgui2::filesystem()->Open("resource/BackgroundLayout.txt", "rb");
	if (!file)
		return;
