...
#include "ui/gameui/MultiplayerAdvancedDialog.h"
#include <stdio.h>
...
#include "ui/vgui2/vgui_controls/RadioButton.h"
#include "ui/vgui2/vgui_controls/ComboBox.h"
#include "ui/vgui2/vgui_controls/ImagePanel.h"
#include "ui/vgui2/vgui_controls/FileOpenDialog.h"
...
#include "ui/gameui/CvarTextEntry.h"
...
#include "ui/gameui/BitmapImagePanel.h"
#include "source_sdk/public/tier1/utlbuffer.h"
#include "ui/gameui/ModInfo.h"
#include "ui/gameui/LogoFile.h"
#include "ui/gameui/BMPUtils.h"
...
COptionsSubMultiplayer::COptionsSubMultiplayer(vgui2::Panel *parent) : vgui2::PropertyPage(parent, "OptionsSubMultiplayer")
{
	...
	m_pLogoList->SetEnabled(engine->pfnGetCvarPointer("cl_logofile") != nullptr);
	m_pColorList->SetEnabled(engine->pfnGetCvarPointer("cl_logocolor") != nullptr);
...
{
	if (!engine->pfnGetCvarPointer("cl_logofile"))
	{
		cb->AddItem("游戏默认", "");
		cb->SetInitialItem(0);
		return;
...
{
	if (!engine->pfnGetCvarPointer("cl_logocolor"))
	{
		m_pColorList->AddItem("游戏默认", "");
		m_pColorList->SetInitialItem(0);
		return;
	}
