...
#include "engine/physics/pm_local.h"
#include "engine/client/cl_tent.h"
...
#include "engine/runtime/library.h"
#include "engine/client/vgui/vgui_draw.h"
#include "engine/audio/sound.h"		// SND_STOP_LOOPING

#ifdef XASH_VGUI2
#include "engine/client/vgui2_surface.h"
#endif
