...
#include "engine_api/types/edict.h"
#include "engine_api/interfaces/eiface.h"
#include "engine_api/interfaces/physint.h"	// physics interface
...
#include "engine_api/types/custom.h"
